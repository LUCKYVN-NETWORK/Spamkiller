...
import me.kuraky.spamkiller.listeners.ChatIntercept;
...
public class Spamkiller extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        consoleCommandSender.sendMessage(defaultPrefix + " Enabling §aProtocolLib §ffork by §bStellarSeal_§f...");
        ...
        ProtocolLibrary.getProtocolManager().addPacketListener(new ChatIntercept());
